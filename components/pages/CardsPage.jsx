...
import {getHeaderKey, isSimilarRegion} from '../../lib/regionUtil'
                    ...
                    return (
                      <li key={card.name}>
                        <section className="toggle-list">
                          ...
                          {isOpen && <Card region={region} card={card}/>}
                        </section>
                      </li>
                    )
                  })}
...
function mapStateToProps(state) {
  ...
  function cardHasValues(card) {
    ...
    if (!hasValues) {
      console.log(`No values in header groups for ${currentRegion.name} and ${tableName}`)
    }
